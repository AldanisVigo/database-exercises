# Create a new file called order_by_exercises.sql and copy and paste the contents of
# your where_exercises.sql.
...
# Irena Pelz and the last result should be Vidya Awdeh.
...
# employee number. Make sure the employee numbers are in the correct order.
